            ...
            {!pathname.includes('/signin') && !pathname.includes('/signout') ? (
                <>
                    ...
                    <header className="sticky top-0 z-50 w-full">
                        ...
                        />
                        <div
                            className={`flex items-center justify-between ${!toggleSearch ? 'border-b border-color-white/35' : ''} bg-color-primary px-4 py-2 sm:px-12`}
                        >
                        ...
                        <div
                            className={`gap-2 bg-color-primary px-4 pb-2 sm:px-12 lg:hidden ${toggleSearch ? 'flex border-b border-color-white/35' : 'hidden'}`}
                        >
